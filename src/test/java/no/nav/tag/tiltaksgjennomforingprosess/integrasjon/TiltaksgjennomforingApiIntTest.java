...
public class TiltaksgjennomforingApiIntTest {
    ...
    @Test
    public void setterAvtalerTilJournalfoert() { // "9f17ac5f-6a3e-47b6-828e-590de574250e" : "001", "463accd8-27cd-4ac7-9735-7cbda7d0a6d2" : "002", "fb8461e5-fb0c-49cf-b349-530c0a086c93" : "00
    ...
    public void henterAvtalerTilJournalfoering() {
        ...
        Avtale avtale = avtaleList.stream().filter(avt -> avt.getTiltakstype().equals(Tiltakstype.ARBEIDSTRENING)).findFirst().get();
        ...
        assertEquals("990983666", avtale.getBedriftNr());
        ...
        assertEquals("NAV IKT", avtale.getBedriftNavn());
        ...
        assertEquals("Følge opp", avtale.getOppfolging());
